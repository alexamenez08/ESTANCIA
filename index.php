...
// Incluir la conexión a la base de datos 
    ...
    require_once "app/controllers/AcademiaController.php";
    require_once "app/controllers/InstrumentoController.php";
    require_once "app/controllers/AplicacionController.php";
    require_once "app/controllers/RespaldoController.php";
    require_once "app/controllers/ReportController.php";
    include_once "public/libraries/fpdf/fpdf.php";


    $nombreControlador = isset($_GET['controlador']) ? ucfirst($_GET['controlador']) . 'Controller' : 'AccesoController';
    
    $nombreAccion = isset($_GET['accion']) ? $_GET['accion'] : 'paginaInicioSesion';
    ...
    if (file_exists($archivoControlador)) {
        ...
        die("Error: El controlador '{$nombreControlador}' no existe en la ruta.");}
